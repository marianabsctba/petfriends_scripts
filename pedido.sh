...
# Caminho do repositório do serviço Pedido
REPO_DIR="C:/Users/mah_b/OneDrive/Área de Trabalho/petfriend_project/petfriends-pedido"

# Nome do microserviço
SERVICE_NAME="petfriends_pedido"
